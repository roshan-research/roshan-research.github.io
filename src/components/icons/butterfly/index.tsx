  ...
  return (
    <div className='relative h-fit w-fit'>
      ...
      <motion.div
        ...
        initial='hidden'
        animate='visible'
        className='absolute left-[375px] top-[317px] flex w-fit -scale-x-100 justify-start overflow-hidden text-[20px] font-[500] text-[#FAFAFA]'
      >
        <span className='-scale-x-100'>پروانه</span>
      </motion.div>
