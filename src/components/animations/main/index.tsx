...
export const conlusion_animation = {
  hidden: {
    opacity: 0,
    y: 10,
  },
...
export const recognizeText_border_animation = {
  hidden: {
    opacity: 0,
  },
  visible: {
