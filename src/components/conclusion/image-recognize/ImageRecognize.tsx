...
const ImageRecognize: FC<ImageRecognizeProps> = ({ activeTab }) => {
  ...
  return (
    <>
      <span className='mb-[120px] mt-[120px] hidden w-full text-center text-xl text-[#FAFAFA] custombp5:block'>
        شناسایی تصویر
      </span>
      <motion.div
      ...
      {/* responsive */}
      <motion.div
        className='relative hidden flex-col items-start gap-[130px] custombp5:-mr-[14px] custombp5:flex'
        onViewportEnter={() => setInview(true)}
      >
        <div className='flex items-center justify-center'>
          <BorderSvg7
          ...
          <motion.div
            ...
            animate={inview ? "visible" : ""}
            viewport={{ once: true, amount: 0.5 }}
            className='absolute -bottom-[96px] right-[188px] h-[36px] w-[77px] bg-[#a86cf333]'
          ></motion.div>
        </div>
