        ...
        <div>
            ...
            >
                ...
                <h4 id={'hazm-main-text'}>
                    ابزاری متن‌باز برای کمک به پردزاش زبان فارسی است که به‌کمک یادگیری ماشینی، درک خوبی از زبان فارسی پیدا کرده و می‌تواند نیازهای زبانی مختلفی را مرتفع کند.
                </h4>
            </motion.div>
            <svg
