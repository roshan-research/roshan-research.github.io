        ...
        <div>
            ...
            >
                ...
                <h4 id={'kashf-main-text'}>
                    مفاهیم موردنظر را در انبوهٔ داده‌های متنی و تصویری
                    جستجو می‌کند؛ مثلاً یافتن دیدگاه‌های منفی دربارهٔ یک محصول یا پیداکردن
                    ویدیوهای مرتبط با فوتبال از بین تعداد زیادی ویدیو.
                </h4>
            </motion.div>
            <svg
