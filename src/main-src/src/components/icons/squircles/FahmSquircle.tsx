  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          <stop stopColor='#88C4FF' stopOpacity='0.2' />
          <stop offset='0.2' stopColor='#88C4FF' stopOpacity='0' />
          <stop offset='0.85' stopColor='#88C4FF' stopOpacity='0' />
