  ...
  return (
    ...
    >
      <path
        ...
        fill='url(#paint0_linear_16492_1505)'
        stroke='url(#paint1_linear_16492_1505)'
      />
      <defs>
        <linearGradient
          id='paint0_linear_16492_1505'
          x1='150.5'
          y1='0'
          x2='150.5'
          y2='300'
        ...
        >
          <stop stopColor='#4E69FE' stopOpacity='0.2' />
          <stop offset='0.2' stopColor='#4E69FE' stopOpacity='0' />
          <stop offset='0.85' stopColor='#4E69FE' stopOpacity='0' />
          <stop offset='1' stopColor='#4E69FE' stopOpacity='0' />
        </linearGradient>
        <linearGradient
          id='paint1_linear_16492_1505'
          x1='150.5'
          y1='0'
          x2='150.5'
          y2='300'
