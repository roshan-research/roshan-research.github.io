...
const HarfSquircle: React.FC<IconProps> = ({ width, height, ...props }) => {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      <path
        ...
        fill='url(#paint0_linear_16402_1453)'
        stroke='url(#paint1_linear_16402_1453)'
      />
      <defs>
        <linearGradient
          id='paint0_linear_16402_1453'
          x1='150'
          y1='0'
          x2='150'
          y2='300'
        ...
        >
          <stop stopColor='#26FF7B' stopOpacity='0.2' />
          <stop offset='0.2' stopColor='#26FF7B' stopOpacity='0' />
          <stop offset='0.85' stopColor='#26FF7B' stopOpacity='0' />
          <stop offset='1' stopColor='#26FF7B' stopOpacity='0' />
        </linearGradient>
        <linearGradient
          id='paint1_linear_16402_1453'
          x1='150'
          y1='0'
          x2='150'
          y2='300'
