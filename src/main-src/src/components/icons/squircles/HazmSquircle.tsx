...
const HazmSquircle: React.FC<IconProps> = ({ width, height, ...props }) => {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      <path
        ...
        fill='url(#paint0_linear_16406_1448)'
        stroke='url(#paint1_linear_16406_1448)'
      />
      <defs>
        <linearGradient
          id='paint0_linear_16406_1448'
          x1='150.5'
          y1='0'
          x2='150.5'
          y2='300'
        ...
        >
          <stop stopColor='#FAD246' stopOpacity='0.2' />
          <stop offset='0.2' stopColor='#FAD246' stopOpacity='0' />
          <stop offset='0.85' stopColor='#FAD246' stopOpacity='0' />
          <stop offset='1' stopColor='#FAD246' stopOpacity='0' />
        </linearGradient>
        <linearGradient
          id='paint1_linear_16406_1448'
          x1='150.5'
          y1='0'
          x2='150.5'
          y2='300'
