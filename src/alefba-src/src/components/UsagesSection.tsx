        ...
        <div>
            ...
            <div id={'usages-section'}>
                ...
                <div id={'in-businesses'} ref={businessesRef} style={businessesInView? afterFade : beforeFade}>
                    ...
                    تهیه‌ی نسخه‌ی متنی اسناد و امکان جستجو در آن‌ها، فایده‌مندی این داده‌ها را برای کسب‌وکارها افزایش می‌دهد.
                    </p>
                </div>
                <div>
                    <div id={'space-2'}/>
                    <div id={'in-organizations'} ref={organizationsRef}  style={organizationsInView? afterFade : beforeFade}>
                        ...
                        <p className={'white-text-usages'}>
                        تبدیل اسناد موجود در اتاق‌های بایگانی به نسخه‌های متنیِ دیجیتال، قدم مهمی در تحقق دنیای بدون کاغذ است.
                        </p>
                    </div>
                </div>
                <div>
                    ...
                    <div id={'in-libraries'} ref={librariesRef}  style={librariesInView? afterFade : beforeFade}>
                        ...
                        <p className={'white-text-usages'}>
                        تهیه‌ی نسخه‌ی متنی کتاب‌ها و امکان جستجو در آن‌ها، تحول بزرگی برای تسریع پژوهش‌ها در دنیای پرشتاب امروز است.
                        </p>
                    </div>
                </div>
            </div>
