            ...
            <div id={'abilities-wrapper'}>
                <div id={'left'}>
                    ...
                    <div className={'ability-group'} id={'left-1'}>
                        ...
                        <p className={'white-text'}>
                            خواندن متون فارسی، انگلیسی و عربی در کنار هم در یک تصویر، بدون نیاز به تنظیم نوع زبان
                        </p>
                    </div>
                ...
                <div id={'right'}>
                    ...
                    <div className={'ability-group'} id={'right-2'}>
                        ...
                        <p className={'white-text'}>
                            درک ساختار سند و لحاظ‌کردن آن در فرایند تبدیل، مثلاً جداول به همان شکل جدولی یا پاراگراف‌ها و تصاویر، با همان ترتیب و جایگاهی که در سند قرار گرفته‌اند در خروجی ارائه می‌شوند
                        </p>
                    </div>
                </div>
            </div>
