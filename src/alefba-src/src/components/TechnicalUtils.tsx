            ...
            <div id={'utils-wrapper'}>
                <div id={'left-utils'}>
                    <div className={'util-group right-to-left'} id={'left-1'}>
                        ...
                        <p className={'white-util-text'}>
                            الفبا در متن‌هایی با کیفیت بالا، دقتی نزدیکِ ۱۰۰ درصد و در متن‌هایی با کیفیت پایین، دقتی به صورت میانگین ۹۷ درصد دارد. این ابزار با یک سرور مقرون‌به‌صرفه می‌تواند
                ...
                <div id={'right-utils'}>
                    ...
                    <div className={'util-group right-to-left'} id={'left-2'}>
                        ...
                        <p className={'white-util-text'}>
                            الفبا می‌تواند برای افزایش سرعت محاسبات، از جی‌پی‌یو نیز استفاده کند. همچنین می‌تواند پردازش‌ها را به صورت توزیع شده نیز انجام شود.                             
                        </p>
                    </div>
                    <div id={'right-space'} />
                    <div className={'util-group left-to-right'} id={'right-2'}>
                        ...
                        <p className={'white-util-text left-to-right'}>
                            الفبا به‌لطف استفاده از تکنولوژی یادگیری عمیق می‌تواند با دقت بسیار بالایی تصاویر را به متن تبدیل کند.
                        </p>
                    </div>
                </div>
            </div>
