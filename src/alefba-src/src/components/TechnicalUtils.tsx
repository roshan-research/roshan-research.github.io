...
const TechnicalUtils = () => {
    ...
    return (
        <div id={'tech-utils'}>
            <p id={'utils-title'}>امکانات فنی الفبا</p>
            <div id={'utils-wrapper'}>
                <div id={'left-utils'}>
                    ...
                    <div className={'util-group left-to-right'} id={'right-1'}>
                        ...
                        <p className={'white-util-text left-to-right'}>
                            الفبا، زبان فارسی را می‌فهمد و هرجایی به تردید
                            بیافتد عبارتی متناسب با بافت و معنای متن انتخاب
                            می‌کند.
                        </p>
                    </div>
                </div>
                <div id={'right-utils'}>
                    ...
                    <div className={'util-group right-to-left'} id={'left-2'}>
                        ...
                        <p className={'white-util-text'}>
                            الفبا می‌تواند با استفاده از پردازنده گرافیکی (کارت
                            گرافیک)، اسناد را چند برابر سریع‌تر پردازش کند.
                            همچنین قابلیت استفاده از چند ماشین برای پردازش
                            توزیع‌شده اسناد را فراهم می‌کند.
                        </p>
                    </div>
                    <div id={'right-space'} />
                    <div className={'util-group left-to-right'} id={'right-2'}>
                        ...
                        <p className={'white-util-text left-to-right'}>
                            الفبا با کمک فناوری های روز دنیا یعنی یادگیری عمیق،
                            خواندن نویسه‌ها را با قلم‌های مختلف یادگرفته است.
                            این فناوری علاوه بر دقت بالا، امکان خواندن قلم‌های
                            تازه را هم برای نویسه‌خوان فراهم می‌کند.
                        </p>
                    </div>
                </div>
            </div>
