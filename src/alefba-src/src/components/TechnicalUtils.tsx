            ...
            <div id={'utils-wrapper'}>
                <div id={'left-utils'}>
                    <div className={'util-group right-to-left'} id={'left-1'}>
                        ...
                        <p className={'white-util-text'}>
                            الفبا در یکی از برآوردهای ما، دقتی نزدیک به ۹۷٪ داشته است. این ابزار با یک سرور مقرون‌به‌صرفه می‌تواند
                ...
                <div id={'right-utils'}>
                    ...
                    <div className={'util-group right-to-left'} id={'left-2'}>
                        ...
                        <p className={'white-util-text'}>
                            الفبا محاسبات را با کمک پردازنده انجام می‌دهد ولی در صورت برخورداری از GPU می‌تواند از قدرت پردازشی جی‌پی‌یو نیز استفاده کند. همچنین الفبا می‌تواند با به‌کارگیری مجموعه‌ای از سیستم‌ها به‌شکل توزیع‌شده، تعداد بیشتری تصویر را به متن تبدیل کند.                        </p>
                    </div>
                    <div id={'right-space'} />
