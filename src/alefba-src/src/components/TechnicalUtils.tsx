                ...
                <div id={'left-utils'}>
                    <div className={'util-group right-to-left'} id={'left-1'}>
                        ...
                        <p className={'white-util-text'}>
                            الفبا در متن‌هایی با کیفیت بالا، دقتی نزدیکِ ۱۰۰ درصد و در متن‌هایی با کیفیت پایین، دقتی با میانگین ۹۷ درصد دارد. این ابزار با یک سرور مقرون‌به‌صرفه می‌تواند
