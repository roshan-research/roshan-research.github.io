                ...
                <div id={'left-utils'}>
                    <div className={'util-group right-to-left'} id={'left-1'}>
                        ...
                        <p className={'white-util-text'}>
                            حرف در صداهایی با کیفیت بالا، دقتی نزدیکِ ۱۰۰ درصد و در صداهایی با کیفیت پایین، دقتی با میانگین ۹۲ درصد دارد . این ابزار با یک سرور مقرون‌به‌صرفه می‌تواند در هر
