    ...
    return (
        <div>
            <motion.div
                ...
                animate={'visible'}
            >
                <h2 id={'kashf-emerging-title'}>الفبا</h2>
            </motion.div>
            <motion.div
                id={'kashf-text-box'}
            ...
            >
                ...
                ابزار الفبا، تصاویر دارای نوشته‌های فارسی، انگلیسی و عربی را با حفظ ساختار سند، به متن‌های قابل ویرایش تبدیل می‌کند. 
                </h4>
            </motion.div>
            <svg
            ...
            >
                ...
                <motion.path
                    ...
                    animate={'visible'}
                    stroke="#FF6200"
                    d="M261.302 59.5 L 287.86 37.882 L 437.12 37.882"
                />
                <motion.path
                    variants={
                    ...
                    animate={'visible'}
                    stroke="#FF6200"
                    d="M341.85 40.529h-53.114l-9.327 7.592"
                />
                <motion.path
                    variants={
                ...
                >
                    ...
                    <motion.path
                        ...
                        stroke="#FF6200"
                        variants={
                            animationChooser(props.status)['boxAnimationNoX']
                        }
                        initial={'hidden'}
                        animate={'visible'}
                    />
