...
var hazm_code_elements = '<span class="o">&gt;&gt;&gt;&nbsp;</span>|<span class="kn">from&nbsp;</span>|<span class="nn">__future__&nbsp;</span>|<span class="kn">import&nbsp;</span>|<span class="n">unicode_literals</span>|\n' +
    ...
    '              <span class="s">\'اصلاح&nbsp;</span>|<span class="s">نویسه ها&nbsp;</span>|<span class="s">و&nbsp;</span>|<span class="s">استفاده&nbsp;</span>|<span class="s">از&nbsp;</span>|<span class="s">نیم&nbsp;</span>|<span class="s">فاصله&nbsp;</span>|<span class="s">پردازش&nbsp;</span>|<span class="s">را&nbsp;</span>|<span class="s">آسان&nbsp;</span>|<span class="s">می کند\'</span>|\n' +
    '              <br><br>\n' +
    '              <span class="o">&gt;&gt;&gt;&nbsp;</span>|<span class="n">sent_tokenize</span>|\n' +
    '              <span class="p">(</span>|\n' +
    '              <span class="s">\'ما&nbsp;</span>|<span class="s">هم&nbsp;</span>|<span class="s">برای&nbsp;</span>|<span class="s">وصل&nbsp;</span>|<span class="s">کردن&nbsp;</span>|<span class="s">آمدیم</span>|<span class="s">!&nbsp;</span>|<span class="s">ولی&nbsp;</span>|<span class="s">برای&nbsp;</span>|<span class="s">پردازش</span>|<span class="s">،&nbsp;</span>|<span class="s">جدا&nbsp;</span>|<span class="s">بهتر&nbsp;</span>|<span class="s">نیست</span>|<span class="s">؟\'</span>|\n'+
    '              <span class="p">)</span>|\n' +
    '              <br>\n' +
    '              <span class="p">[</span>|\n' +
    '              <span class="s">\'ما&nbsp;</span>|<span class="s">هم&nbsp;</span>|<span class="s">برای&nbsp;</span>|<span class="s">وصل&nbsp;</span>|<span class="s">کردن&nbsp;</span>|<span class="s">آمدیم</span>|<span class="s">!</span>|'+
    '              <span class="p">,</span>|\n'+
    '              <span class="s">ولی&nbsp;</span>|<span class="s">برای&nbsp;</span>|<span class="s">پردازش</span>|<span class="s">،&nbsp;</span>|<span class="s">جدا&nbsp;</span>|<span class="s">بهتر&nbsp;</span>|<span class="s">نیست</span>|<span class="s">؟\'</span>|' +
    '              <span class="p">]</span>|\n' +
    '              <br>\n' +
    ...
    '              <span class="s">\'</span>|<span class="s">resources</span>|<span class="s">/</span>|<span class="s">postagger</span>|<span class="s">.</span>|<span class="s">model</span>|<span class="s">\'</span>|\n' +
    '              <span class="p">)</span>|\n' +
    '              <br>\n' +
    '              <span class="o">&gt;&gt;&gt;&nbsp;</span>|<span class="n">tagger</span>|<span class="o">.</span>|<span class="n">tag</span>|<span class="p">(</span>|<span class="n">word_tokenize</span>|<span class="p">(</span>|\n'+
    '              <span class="s">\'</span>|<span class="s">ما&nbsp;</span>|<span class="s">بسیار&nbsp;</span>|<span class="s">کتاب&nbsp;</span>|<span class="s">می خوانیم</span>|<span class="s">\'</span>|\n' +
    '              <span class="p">))</span>|\n' +
    '              <br>\n' +
    '              <span class="p">[(</span>|<span class="s">\'ما\'</span>|<span class="p">,</span>|<span class="s">\'PRO\'</span>|<span class="p">),</span>|<span class="p">(</span>|<span class="s">\'بسیار\'</span>|<span class="p">,</span>|<span class="s">\'ADV\'</span>|<span class="p">),</span>|<span class="p">(</span>|<span class="s">\'کتاب\'</span>|<span class="p">,</span>|\n' +
    '              <span class="s">\'N\'</span>|<span class="p">),</span>| <span class="p">(</span>|<span class="s">\'می&zwnj;خوانیم\'</span>|<span class="p">,</span>| <span class="s">\'V\'</span>|<span class="p">)]</span>|\n' +
    '              <br><br>\n' +
    '              <span class="o">&gt;&gt;&gt;&nbsp;</span>|<span class="n">chunker&nbsp;</span>|<span class="o">=&nbsp;</span>|<span class="n">Chunker</span>|<span class="p">(</span>|<span class="n">model</span>|<span class="o">=</span>|\n' +
    '              <span class="s">\'resources</span>|<span class="s">/</span>|<span class="s">chunker</span>|<span class="s">.</span>|<span class="s">model\'</span>|\n' +
    '              <span class="p">)</span>|\n' +
    '              <br>\n' +
    '              <span class="o">&gt;&gt;&gt;&nbsp;</span>|<span class="n">tagged&nbsp;</span>|<span class="o">=&nbsp;</span>|<span class="n">tagger</span>|<span class="o">.</span>|<span class="n">tag</span>|<span class="p">(</span>|<span class="n">word_tokenize</span>|<span class="p">(</span>|\n' +
    '              <span class="s">\'کتاب&nbsp;</span>|<span class="s">خواندن&nbsp;</span>|<span class="s">را&nbsp;</span>|<span class="s">دوست&nbsp;</span|<span class="s">داریم\'</span>|\n' +
    '              <span class="p">))</span>|\n' +
    '              <br>\n' +
    ...
    '              <br>\n' +
    '              <span class="s">\'[</span><span class="s">کتاب&nbsp;</span>|<span class="s">خواندن&nbsp;</span>|<span class="s">NP</span>|<span class="s">]&nbsp;</span>|\n ' +
    '              <span class="s">[</span>|<span class="s">را&nbsp;</span>|<span class="s">POSTP</span>|<span class="s">]&nbsp;</span>|<span class="s">[</span>|<span class="s">دوست&nbsp;</span>|<span class="s">داریم&nbsp;</span>|<span class="s">VP</span>|<span class="s">]\'</span>|\n' +
    '              <br><br>\n' +
    ...
    '              <br>\n' +
    '              <span class="o">&gt;&gt;&gt;&nbsp;</span>|<span class="n">parser</span>|<span class="o">.</span>|<span class="n">parse</span>|<span class="p">(</span>|<span class="n">word_tokenize</span>|<span class="p">(</span>|\n' +
    '              <span class="s">\'</span>|<span class="s">زنگ ها&nbsp;</span>|<span class="s">برای&nbsp;</span>|<span class="s">کی&nbsp;</span>|<span class="s">به&nbsp;</span>|<span class="s">صدا&nbsp;</span>|<span class="s">در&nbsp;</span>|<span class="s">می آید</span>|<span class="s">؟\'</span>|\n' +
    '              <span class="p">))</span>|\n' +
    '              <br>\n' +
