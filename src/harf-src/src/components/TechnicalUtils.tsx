...
const TechnicalUtils = () => {
    ...
    return (
        <div id={'tech-utils'}>
            <p id={'utils-title'}>ویژگی‌های فنی حرف</p>
            ...
            <div id={'utils-wrapper'}>
                <div id={'left-utils'}>
                    <div className={'util-group right-to-left'} id={'left-1'}>
                        ...
                        <p className={'white-util-text'}>
                            حرف در یکی از برآوردهای ما، دقتی نزدیک به ۹۲٪ داشته است. این ابزار با یک سرور مقرون‌به‌صرفه می‌تواند در هر
                            دقیقه، یک ساعت صوت/ویدیو را پردازش کند.
                        </p>
                    </div>
                    <div id={'right-space'} />
                    <div className={'util-group left-to-right'} id={'right-1'}>
                        ...
                        <p className={'white-util-text left-to-right'}>
                            حرف، هرجایی در تشخیص به تردید بیفتد از بافتِ متن کمک
                            می‌گیرد و بر اساس آن محتمل‌ترین کلمه را انتخاب
                            می‌کند.
                        </p>
                    </div>
                </div>
                <div id={'right-utils'}>
                    ...
                    <div className={'util-group right-to-left'} id={'left-2'}>
                        ...
                        <p className={'white-util-text'}>
                        حرف محاسبات را با کمک پردازنده انجام می‌دهد ولی در صورت برخورداری از GPU می‌تواند از قدرت پردازشی جی‌پی‌یو نیز استفاده کند. همچنین الفبا می‌تواند با به‌کارگیری مجموعه‌ای از سیستم‌ها به‌شکل توزیع‌شده، تعداد بیشتری گفتار را به متن تبدیل کند.
                    ...
                    <div className={'util-group left-to-right'} id={'right-2'}>
                        ...
                        <p className={'white-util-text left-to-right'}>
                        حرف، به‌لطف استفاده از تکنولوژی یادگیری عمیق، قادر است با دقتی بسیار بالاتر از روش‌های رایج، گفتار را به متن تبدیل کند.
                        </p>
                    </div>
                </div>
            </div>
