            ...
            <div id={'utils-wrapper'}>
                <div id={'left-utils'}>
                    <div className={'util-group right-to-left'} id={'left-1'}>
                        ...
                        <p className={'white-util-text'}>
                            حرف در صداهایی با کیفیت بالا، دقتی نزدیکِ ۱۰۰ درصد و در صداهایی با کیفیت پایین، دقتی به صورت میانگین ۹۲ درصد دارد . این ابزار با یک سرور مقرون‌به‌صرفه می‌تواند در هر
                            دقیقه، یک ساعت صوت یا ویدیو را پردازش کند.
                        </p>
                    </div>
                    <div id={'right-space'} />
                ...
                <div id={'right-utils'}>
                    ...
                    <div className={'util-group right-to-left'} id={'left-2'}>
                        ...
                        <p className={'white-util-text'}>
                        حرف می‌تواند برای افزایش سرعت محاسبات، از جی‌پی‌یو نیز استفاده کند. همچنین می‌تواند پردازش‌ها را به صورت توزیع شده نیز انجام شود
                        </p>
                    </div>
                    <div id={'right-space'} />
                    <div className={'util-group left-to-right'} id={'right-2'}>
                        ...
                        <p className={'white-util-text left-to-right'}>
                        حرف به‌لطف استفاده از تکنولوژی یادگیری عمیق می‌تواند با دقت بسیار بالایی گفتار را به متن تبدیل کند.
                        </p>
                    </div>
                </div>
            </div>
