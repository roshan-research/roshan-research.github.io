            ...
            <div id={'utils-wrapper'}>
                ...
                <div id={'right-utils'}>
                    ...
                    <div className={'util-group right-to-left'} id={'left-2'}>
                        ...
                        <p className={'white-util-text'}>
                        حرف محاسبات را با کمک پردازنده انجام می‌دهد ولی در صورت برخورداری از GPU می‌تواند از قدرت پردازشی جی‌پی‌یو نیز استفاده کند. همچنین، حرف می‌تواند با به‌کارگیری مجموعه‌ای از سیستم‌ها به‌شکل توزیع‌شده، تعداد بیشتری گفتار را به متن تبدیل کند.
