            ...
            <div id={'utils-wrapper'}>
                <div id={'left-utils'}>
                    <div className={'util-group right-to-left'} id={'left-1'}>
                        ...
                        <p className={'white-util-text'}>
                            حرف، طبق برآوردهای ما می‌تواند دقتی تا ۹۲٪ داشته باشد. این ابزار با یک سرور مقرون‌به‌صرفه می‌تواند در هر
                ...
                <div id={'right-utils'}>
                    ...
                    <div className={'util-group right-to-left'} id={'left-2'}>
                        ...
                        <p className={'white-util-text'}>
                        حرف، در صورت برخورداری از GPU و اجرا روی سیستم‌های توزیع‌شده، سرعتی چند برابر اجرا روی پردازنده خواهد داشت.
                        </p>
                    </div>
                    <div id={'right-space'} />
