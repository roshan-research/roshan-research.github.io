    ...
    return (
        <div>
            ...
            <motion.div
                ...
                animate={"visible"}
            >
                <h1 id={'hazm-title-text'}>
                    تحلیل متن های فارسی
                </h1>
                <h4 id={'hazm-main-text'}>
                    هضم متون فارسی را تمیز و مرتب می کند.
                    همچنین توانایی تقطیع جمله‌‌ها و واژه‌ها،
                    <br/>
                    ریشه‌یابی واژه‌ها، تحلیل صرفی و تجزیه نحوی جمله ها را نیز دارد.
                </h4>
            </motion.div>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 450 301">
                <motion.path
                ...
                <motion.path
                    ...
                    initial={"hidden"}
                    animate={"visible"}
                    stroke="#0089FF" d="M327.85 40.529h-53.114l-9.327 7.592"/>
                <motion.path
